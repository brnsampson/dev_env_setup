wget -q https://releases.hashicorp.com/vagrant/2.2.14/vagrant_2.2.14_SHA256SUMS -O vagrant_SHA256SUMS
wget -q https://releases.hashicorp.com/vagrant/2.2.14/vagrant_2.2.14_SHA256SUMS.sig -O vagrant_SHA256SUMS.sig
wget -q https://releases.hashicorp.com/vagrant/2.2.14/vagrant_2.2.14_x86_64.deb -O vagrant_2.2.14_x86_64.deb
...
rm vagrant_SHA256SUMS vagrant_SHA256SUMS.sig hashicorp.asc vagrant_2.2.14_x86_64.deb
